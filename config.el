...
(use-package ruby-mode
  ...
  (defun underscore-words ()
    (modify-syntax-entry ?_ "w"))
  :hook ((ruby-mode . underscore-words))
  :ensure t
  :config)
...
(defun org-babel-execute:js (body params)
  "Execute a block of JS code with org-babel."
  (let ((in-file (org-babel-temp-file "n" ".js"))
...
(defun org-babel-execute:powershell (body params)
  (let ((in-file (org-babel-temp-file "n" ".ps1"))
        (verbosity (or (cdr (assq :verbosity params)) 0)))
    (with-temp-file in-file (insert body))
    (org-babel-eval
      (format "powershell -ExecutionPolicy Bypass -File %s"
              (org-babel-process-file-name in-file))
      "")))
...
(use-package magit :ensure t :defer 3)
